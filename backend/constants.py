...
test_mustache_manual = os.path.join(mustaches_dir, r"test_models_manual.mustache")
...
selenium_mustache_sample = os.path.join(
    mustaches_dir, r"selenium_models_sample.mustache"
)
